...
public class ShetuanxinwenController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShetuanxinwenEntity shetuanxinwen, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("shetuanfuzeren")) {
			shetuanxinwen.setShetuanbianhao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShetuanxinwenEntity shetuanxinwen, HttpServletRequest request){
        EntityWrapper<ShetuanxinwenEntity> ew = new EntityWrapper<ShetuanxinwenEntity>();
		PageUtils page = shetuanxinwenService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shetuanxinwen), params), params));
        return R.ok().put("data", page);
    }
