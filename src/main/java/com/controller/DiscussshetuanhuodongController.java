...
public class DiscussshetuanhuodongController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussshetuanhuodongEntity discussshetuanhuodong, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussshetuanhuodongEntity discussshetuanhuodong, HttpServletRequest request){
        EntityWrapper<DiscussshetuanhuodongEntity> ew = new EntityWrapper<DiscussshetuanhuodongEntity>();
		PageUtils page = discussshetuanhuodongService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussshetuanhuodong), params), params));
        return R.ok().put("data", page);
    }
