...
public class YonghuzixunController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YonghuzixunEntity yonghuzixun, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("shetuanfuzeren")) {
			yonghuzixun.setShetuanbianhao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			yonghuzixun.setYonghuming((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YonghuzixunEntity yonghuzixun, HttpServletRequest request){
        EntityWrapper<YonghuzixunEntity> ew = new EntityWrapper<YonghuzixunEntity>();
		PageUtils page = yonghuzixunService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yonghuzixun), params), params));
        return R.ok().put("data", page);
    }
