<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="经费名称" prop="jingfeimingcheng">
          <el-input v-model="ruleForm.jingfeimingcheng" 
              placeholder="经费名称" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="经费名称" prop="jingfeimingcheng">
              <el-input v-model="ruleForm.jingfeimingcheng" 
                placeholder="经费名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="备注" prop="beizhu">
              <el-input v-model="ruleForm.beizhu" 
                placeholder="备注" readonly></el-input>
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="经费内容" prop="jingfeineirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jingfeineirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jingfeineirong" label="经费内容" prop="jingfeineirong">
                    <span v-html="ruleForm.jingfeineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
                    if(o=='jingfeimingcheng'){
            this.ruleForm.jingfeimingcheng = obj[o];
            continue;
          }
                    if(o=='shetuanbianhao'){
            ...
            continue;
                    ...
                    if(o=='jingfeineirong'){
            this.ruleForm.jingfeineirong = obj[o];
            continue;
          }
                    if(o=='beizhu'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shetuanjingfei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shetuanjingfeiCrossAddOrUpdateFlag = false;
                  this.parent.search();
