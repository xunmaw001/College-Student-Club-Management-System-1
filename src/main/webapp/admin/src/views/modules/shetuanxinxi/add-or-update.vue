      ...
      <el-row>
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="社团宗旨" prop="shetuanzongzhi">
          <el-input v-model="ruleForm.shetuanzongzhi" 
              placeholder="社团宗旨" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="社团宗旨" prop="shetuanzongzhi">
              <el-input v-model="ruleForm.shetuanzongzhi" 
                placeholder="社团宗旨" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="创办日期" prop="chuangbanriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.chuangbanriqi" 
                type="date"
                placeholder="创办日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chuangbanriqi" label="创办日期" prop="chuangbanriqi">
              <el-input v-model="ruleForm.chuangbanriqi" 
                placeholder="创办日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="社团地址" prop="shetuandizhi">
          <el-input v-model="ruleForm.shetuandizhi" 
              placeholder="社团地址" clearable ></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item class="input" label="邮箱" prop="youxiang">
              <el-input v-model="ruleForm.youxiang" 
                placeholder="邮箱" readonly></el-input>
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="社团风采" prop="shetuanfengcai">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shetuanfengcai" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shetuanfengcai" label="社团风采" prop="shetuanfengcai">
                    <span v-html="ruleForm.shetuanfengcai"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='chuangbanriqi'){
            this.ruleForm.chuangbanriqi = obj[o];
            continue;
          }
                    if(o=='shetuandizhi'){
