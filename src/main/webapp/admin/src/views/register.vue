  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.22);borderRadius:10px">
        <h1 class="h1" style="color:rgba(104, 223, 240, 1);fontSize:28px;">大学生社团管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证" type="text" />
																								...
																								<!-- <div v-if="tableName=='shetuanfuzeren'" class="input-group">
			   <div class="label">社团编号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shetuanbianhao" class="input" type="text" placeholder="社团编号">
			   </div>
			 </div> -->
			<el-form-item label="社团编号" class="input" v-if="tableName=='shetuanfuzeren'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='shetuanfuzeren'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='shetuanfuzeren'" class="input-group">
			   <div class="label">姓名</div>
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='shetuanfuzeren'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='shetuanfuzeren'" class="input-group">
			...
			<el-form-item label="社团名称" class="input" v-if="tableName=='shetuanfuzeren'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='shetuanfuzeren'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='shetuanfuzeren'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='shetuanfuzeren'" class="input-group">
			   <div class="label">身份证</div>
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='shetuanfuzeren'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证" type="text" />
			</el-form-item>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                      ...
                                                      if((!this.ruleForm.shetuanbianhao) && `shetuanfuzeren` == this.tableName){
        this.$message.error(`社团编号不能为空`);
        return
      }
                                                            if((!this.ruleForm.mima) && `shetuanfuzeren` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                            if((!this.ruleForm.xingming) && `shetuanfuzeren` == this.tableName){
        this.$message.error(`姓名不能为空`);
        return
      }
                                                                                                                                                                                                                                                                                    if(`shetuanfuzeren` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
                                                                  if(`shetuanfuzeren` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
        this.$message.error(`身份证应输入身份证格式`);
        return
      }
                                                                                                                                                                                                this.$http({
